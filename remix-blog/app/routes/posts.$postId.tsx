  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-lg mx-auto bg-white rounded-lg shadow-lg p-6 mt-5">
       {post.title && <h2 className="text-2xl font-semibold text-gray-800">{post.title}</h2>}
       {post._createdAt && <p className="mt-2 text-gray-600">Published: {new Date(post._createdAt).toLocaleDateString('en-UK')}</p>}
